...
public class Constants {
    ...
    public static final String APP_ID = "ubqKZsFfZsHmqcNzEEoyT5XrbUB497cWVtdTb6tpV5g";
    public static final String SDK_KEY = "AdophLqz8mFi4GV6S4a1znoHa2Db6Qs8XkC7B7JUApB3";
